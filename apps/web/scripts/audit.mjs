...
await page.waitForSelector('text=开始新对话', { timeout: 10_000 })
...
await page.waitForSelector('button:has-text("发送")', { timeout: 90_000 }).catch(() => issues.push('回合未在 90s 内结束(发送按钮未恢复)'))
await page.waitForTimeout(800)
const metricsText = await page.locator('main > div.border-t').first().textContent().catch(() => null)
...
await page.waitForSelector('text=开始新对话, text=轮数', { timeout: 10_000 }).catch(() => {})
await page.waitForTimeout(600)
