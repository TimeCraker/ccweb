...
/**
 * markdown 渲染管线(react-markdown + GFM + highlight.js)。
 * 独立 chunk 懒加载:高亮/解析器约占主包一半体积,拆出后首屏显著变轻;
 * 加载完成前由 Markdown.tsx 的 Suspense fallback 以纯文本渐进展示。
 */
...
export default function MarkdownPipeline({ text }: { text: string }) {
  return (
    <ReactMarkdown
